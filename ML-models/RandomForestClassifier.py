...
logger = logging.getLogger("Random Forest Classifier")
...
def train(annotations_file,
    ...
    logger.info(f'Random Forest Classifier with {imputed_X_ni.shape[0]} training sites x {imputed_X_ni.shape[1]} annotations...')
    clf = RandomForestClassifier(**hyperparameters_kwargs)
